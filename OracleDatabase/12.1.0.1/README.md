...
[http://www.oracle.com/technetwork/database/enterprise-edition/downloads/index.html](http://www.oracle.com/technetwork/database/enterprise-edition/downloads/index.html). There are separate zip files for Enterprise Edition (EE) and Standard Edition 2 (SE2). Each edition requires 2 zip files. Make sure to download the correct files for the edition you want to use.
4. Run `vagrant up`
